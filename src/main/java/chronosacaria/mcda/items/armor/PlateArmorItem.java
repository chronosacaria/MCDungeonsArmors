...
public class PlateArmorItem extends ArmorItem {
    ...
    public PlateArmorItem(ArmorMaterial armorMaterial, EquipmentSlot slot, Settings settings,
        ...
        builder.put(EntityAttributes.GENERIC_ARMOR, new EntityAttributeModifier(uuid,
                "Armor modifier",
                this.protection, EntityAttributeModifier.Operation.ADDITION));
        builder.put(EntityAttributes.GENERIC_ARMOR_TOUGHNESS, new EntityAttributeModifier(uuid,
                "Armor toughness",
        ...
        if(this.base){
            builder.put(EntityAttributes.GENERIC_ATTACK_DAMAGE, new EntityAttributeModifier(uuid,
                    ...
                    McdaBoostsConfig.config.PlateArmourSetAttackDamageBoost, EntityAttributeModifier.Operation.MULTIPLY_BASE));
            builder.put(EntityAttributes.GENERIC_ATTACK_SPEED, new EntityAttributeModifier(uuid,
                    "Armor attack speed boost",
                    McdaBoostsConfig.config.PlateArmourSetAttackSpeedBoost, EntityAttributeModifier.Operation.MULTIPLY_BASE));
        ...
        if(this.unique){
            builder.put(EntityAttributes.GENERIC_ATTACK_DAMAGE, new EntityAttributeModifier(uuid,
                    "Armor attack damage boost",
                    McdaBoostsConfig.config.FullMetalArmourSetAttackDamageBoost,
                    EntityAttributeModifier.Operation.MULTIPLY_BASE));
            builder.put(EntityAttributes.GENERIC_ATTACK_SPEED, new EntityAttributeModifier(uuid,
                    "Armor attack speed boost",
                    McdaBoostsConfig.config.FullMetalArmourSetAttackSpeedBoost,
                    EntityAttributeModifier.Operation.MULTIPLY_BASE));
            builder.put(EntityAttributes.GENERIC_MOVEMENT_SPEED, new EntityAttributeModifier(uuid,
                    "Armor movement speed detriment",
    ...
    public void appendTooltip(ItemStack itemStack, World world, List<Text> tooltip, TooltipContext tooltipContext){
        ...
        if(this.base){
            tooltip.add(new TranslatableText("item.mcda.plate_armor.tooltip_1"));
            tooltip.add(new TranslatableText("item.mcda.plate_armor.tooltip_2"));
            tooltip.add(new TranslatableText("item.mcda.plate_armor.tooltip_3"));
        }
        if(this.unique) {
            tooltip.add(new TranslatableText("item.mcda.full_metal_armor.tooltip_1"));
            tooltip.add(new TranslatableText("item.mcda.full_metal_armor.tooltip_2"));
        }
