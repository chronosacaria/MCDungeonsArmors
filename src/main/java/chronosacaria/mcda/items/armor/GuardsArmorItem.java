...
public class GuardsArmorItem extends ArmorItem {
    ...
    public GuardsArmorItem(ArmorMaterial armorMaterial, EquipmentSlot slot, Settings settings,
        ...
        if(this.base){
            builder.put(EntityAttributes.GENERIC_ATTACK_DAMAGE, new EntityAttributeModifier(uuid,
                    ...
                    McdaBoostsConfig.config.GuardsArmourSetAttackSpeedBoost, EntityAttributeModifier.Operation.MULTIPLY_BASE));
            builder.put(EntityAttributes.GENERIC_ATTACK_SPEED, new EntityAttributeModifier(uuid,
                    "Armor attack speed boost",
                    McdaBoostsConfig.config.GuardsArmourSetAttackDamageBoost, EntityAttributeModifier.Operation.MULTIPLY_BASE));
            builder.put(EntityAttributes.GENERIC_MOVEMENT_SPEED, new EntityAttributeModifier(uuid,
                    "Armor movement speed boost",
                    McdaBoostsConfig.config.GuardsArmourSetMovementBoost, EntityAttributeModifier.Operation.MULTIPLY_BASE));
        }
        if(this.unique){
            builder.put(EntityAttributes.GENERIC_ATTACK_DAMAGE, new EntityAttributeModifier(uuid,
                    "Armor attack damage boost",
                    McdaBoostsConfig.config.CuriousArmourSetAttackDamageBoost, EntityAttributeModifier.Operation.MULTIPLY_BASE));
            builder.put(EntityAttributes.GENERIC_ATTACK_SPEED, new EntityAttributeModifier(uuid,
                    "Armor attack speed boost",
                    McdaBoostsConfig.config.CuriousArmourSetAttackSpeedBoost, EntityAttributeModifier.Operation.MULTIPLY_BASE));
            builder.put(EntityAttributes.GENERIC_MOVEMENT_SPEED, new EntityAttributeModifier(uuid,
                    "Armor movement speed boost",
                    McdaBoostsConfig.config.CuriousArmourSetMovementBoost, EntityAttributeModifier.Operation.MULTIPLY_BASE));
        }
    ...
    public void appendTooltip(ItemStack itemStack, World world, List<Text> tooltip, TooltipContext tooltipContext){
        ...
        if(this.unique) {
            tooltip.add(new TranslatableText("item.mcda.curious_armor.tooltip_1"));
            tooltip.add(new TranslatableText("item.mcda.curious_armor.tooltip_2"));
            tooltip.add(new TranslatableText("item.mcda.curious_armor.tooltip_3"));
        }
        else {
            tooltip.add(new TranslatableText("item.mcda.guards_armor.tooltip_1"));
            tooltip.add(new TranslatableText("item.mcda.guards_armor.tooltip_2"));
            tooltip.add(new TranslatableText("item.mcda.guards_armor.tooltip_3"));
