...
public class SoulRobeArmorItem extends ArmorItem {
    ...
    public SoulRobeArmorItem(ArmorMaterial armorMaterial, EquipmentSlot slot, Settings settings,
        ...
        if(this.base){
            builder.put(EntityAttributes.GENERIC_ATTACK_DAMAGE, new EntityAttributeModifier(uuid,
                    ...
                    McdaBoostsConfig.config.getSoulRobeSetAttackDamageBoost(), EntityAttributeModifier.Operation.MULTIPLY_BASE));
            builder.put(EntityAttributes.GENERIC_ATTACK_SPEED, new EntityAttributeModifier(uuid,
                    "Armor attack speed boost",
                    McdaBoostsConfig.config.getSoulRobeSetAttackSpeedBoost(), EntityAttributeModifier.Operation.MULTIPLY_BASE));
            builder.put(EntityAttributes.GENERIC_MOVEMENT_SPEED, new EntityAttributeModifier(uuid,
                    "Armor movement speed boost",
                    McdaBoostsConfig.config.getSoulRobeSetMovementBoost(), EntityAttributeModifier.Operation.MULTIPLY_BASE));
        }
        if(this.unique){
            builder.put(EntityAttributes.GENERIC_ATTACK_DAMAGE, new EntityAttributeModifier(uuid,
                    "Armor attack damage boost",
                    McdaBoostsConfig.config.getSoulDancerRobeSetAttackDamageBoost(), EntityAttributeModifier.Operation.MULTIPLY_BASE));
            builder.put(EntityAttributes.GENERIC_ATTACK_SPEED, new EntityAttributeModifier(uuid,
                    "Armor attack speed boost",
                    McdaBoostsConfig.config.getSoulDancerRobeSetAttackSpeedBoost(), EntityAttributeModifier.Operation.MULTIPLY_BASE));
            builder.put(EntityAttributes.GENERIC_MOVEMENT_SPEED, new EntityAttributeModifier(uuid,
                    "Armor movement speed boost",
                    McdaBoostsConfig.config.getSoulDancerRobeSetMovementBoost(), EntityAttributeModifier.Operation.MULTIPLY_BASE));
        }
    ...
    public void appendTooltip(ItemStack itemStack, World world, List<Text> tooltip, TooltipContext tooltipContext){
        ...
        if(this.base){
            tooltip.add(new TranslatableText("item.mcda.soul_robe.tooltip_1"));
            tooltip.add(new TranslatableText("item.mcda.soul_robe.tooltip_2"));
            tooltip.add(new TranslatableText("item.mcda.soul_robe.tooltip_3"));
        }
        if(this.unique) {
            tooltip.add(new TranslatableText("item.mcda.souldancer_robe.tooltip_1"));
            tooltip.add(new TranslatableText("item.mcda.souldancer_robe.tooltip_2"));
            tooltip.add(new TranslatableText("item.mcda.souldancer_robe.tooltip_3"));
        }
