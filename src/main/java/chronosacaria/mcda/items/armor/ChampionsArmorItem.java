...
public class ChampionsArmorItem extends ArmorItem {
    ...
    public ChampionsArmorItem(ArmorMaterial armorMaterial, EquipmentSlot slot, Settings settings,
        ...
        if(this.base){
            builder.put(EntityAttributes.GENERIC_ATTACK_DAMAGE, new EntityAttributeModifier(uuid,
                    ...
                    McdaBoostsConfig.config.ChampionArmourSetAttackDamageBoost,
                    EntityAttributeModifier.Operation.MULTIPLY_BASE));

            builder.put(EntityAttributes.GENERIC_ATTACK_SPEED, new EntityAttributeModifier(uuid,
                    "Armor attack speed boost",
                    McdaBoostsConfig.config.ChampionArmourSetAttackSpeedBoost,
                    EntityAttributeModifier.Operation.MULTIPLY_BASE));

            builder.put(EntityAttributes.GENERIC_MOVEMENT_SPEED, new EntityAttributeModifier(uuid,
                    "Armor movement speed boost",
                    McdaBoostsConfig.config.ChampionArmourSetMovementBoost, EntityAttributeModifier.Operation.MULTIPLY_BASE));
        }
        if(this.unique){
            builder.put(EntityAttributes.GENERIC_ATTACK_DAMAGE, new EntityAttributeModifier(uuid,
                    "Armor attack damage boost",
                    McdaBoostsConfig.config.HeroArmourSetAttackDamageBoost, EntityAttributeModifier.Operation.MULTIPLY_BASE));

            builder.put(EntityAttributes.GENERIC_ATTACK_SPEED, new EntityAttributeModifier(uuid,
                    "Armor attack speed boost",
                    McdaBoostsConfig.config.HeroArmourSetAttackSpeedBoost,
                    EntityAttributeModifier.Operation.MULTIPLY_BASE));

            builder.put(EntityAttributes.GENERIC_MOVEMENT_SPEED, new EntityAttributeModifier(uuid,
                    "Armor movement speed boost",
                    McdaBoostsConfig.config.HeroArmourSetMovementBoost,
                    EntityAttributeModifier.Operation.MULTIPLY_BASE));
        }
    ...
    public void appendTooltip(ItemStack itemStack, World world, List<Text> tooltip, TooltipContext tooltipContext){
        ...
        if(this.unique) {
            tooltip.add(new TranslatableText("item.mcda.champions_armor.tooltip_1"));
            tooltip.add(new TranslatableText("item.mcda.champions_armor.tooltip_2"));
            tooltip.add(new TranslatableText("item.mcda.champions_armor.tooltip_3"));
            tooltip.add(new TranslatableText("item.mcda.champions_armor.tooltip_4"));
            tooltip.add(new TranslatableText("item.mcda.champions_armor.tooltip_5"));
        }
        else {
            tooltip.add(new TranslatableText("item.mcda.heros_armor.tooltip_1"));
            tooltip.add(new TranslatableText("item.mcda.heros_armor.tooltip_2"));
            tooltip.add(new TranslatableText("item.mcda.heros_armor.tooltip_3"));
        }
