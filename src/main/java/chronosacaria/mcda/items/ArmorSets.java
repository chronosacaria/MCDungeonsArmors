...
public enum ArmorSets implements ArmorMaterial {
    ...
    GOAT("goat", "goat_gear",
            15,
            ITEM_ARMOR_EQUIP_LEATHER,
            ItemsRegistry.items.get(ItemID.GOAT_PELT)),
    ...
    BATTLE("battle", "battle_robe",
            ...
            ItemsRegistry.items.get(ItemID.FABRIC_BOLT_BLACK)),
    SPLENDID("splendid", "splendid_robe",
            25,
            ITEM_ARMOR_EQUIP_ELYTRA,
            ItemsRegistry.items.get(ItemID.FABRIC_BOLT_PURPLE)),
    EVOCATION("evocation", "evocation_robe",
            25,
            ITEM_ARMOR_EQUIP_ELYTRA,
            ItemsRegistry.items.get(ItemID.FABRIC_BOLT_BLUE)),
    EMBER("ember", "ember_robe",
            25,
            ITEM_ARMOR_EQUIP_ELYTRA,
            ItemsRegistry.items.get(ItemID.FABRIC_BOLT_RED)),
    VERDANT("verdant", "verdant_robe",
            25,
            ITEM_ARMOR_EQUIP_ELYTRA,
            ItemsRegistry.items.get(ItemID.FABRIC_BOLT_GREEN)),
    ...
    SPROUT("sprout", "sprout_armor",
            25,
            ITEM_ARMOR_EQUIP_ELYTRA,
            ItemsRegistry.items.get(ItemID.FABRIC_BOLT_CYAN)),
    ...
    TROUBADOUR("troubadour", "troubadour_armor",
            25,
            ITEM_ARMOR_EQUIP_ELYTRA,
            ItemsRegistry.items.get(ItemID.FABRIC_BOLT_MAGENTA)),
    ...
    PHANTOM("phantom", "phantom_armor",
            ...
            ItemsRegistry.items.get(ItemID.PHANTOM_BONES)),
    FROST_BITE("frostbite", "frost_bite_armor",
            9,
            ENTITY_SKELETON_AMBIENT,
            ItemsRegistry.items.get(ItemID.FROST_CRYSTAL)),
    ...
    SCALE_MAIL("scale", "scale_mail",
            9,
            ITEM_ARMOR_EQUIP_IRON,
            ItemsRegistry.items.get(ItemID.IRON_SCALE)),
    ...
    REINFORCED_MAIL("reinforced", "reinforced_mail",
            ...
            ItemsRegistry.items.get(ItemID.IRON_PLATE)),
    ...
    HUNGRY_HORROR("hungryhorror", "hungry_horror",
            9,
            ITEM_ARMOR_EQUIP_DIAMOND,
            ItemsRegistry.items.get(ItemID.GLUT_CHARM)),
